        ...
        <div id="home" className="flex w-full h-screen flex-col md:flex-row gap-5 items-center justify-center text-white relative">
            ...
            <div className='md:w-3/6' data-aos="fade-right" data-aos-duration="1000" data-aos-offset="100" >
                <div className="flex flex-col w-full mt-8">
                    ...
                    <h1 className="text-2xl font-bold" style={{color: "#00FECA"}}>Haruka Kobayashi</h1>
                    <p class="text-xl font-bold text-gray-300">Welcome to my page</p>
                    <p className="text-md font-light text-gray-400 ">I am currently studying machine learning at the University of Tokyo, and I have a strong interest in solving problems in competitive programming. In addition to my studies, I work part-time in the field of machine learning.</p>
                </div>
